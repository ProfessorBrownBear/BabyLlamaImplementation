...
Example input file that demonstrates the basic operations of the Baby Llama 2 interpreter. You can use this input file to showcase the 
    interpreter's functionalities:
    
Create a new text file and name it "baby_llama_demo.bl2". In this file, you can add the following Baby Llama 2 code:

makefile
Copy code
# This is a Baby Llama 2 code demo
...
The first line is a comment that provides some information about the code. 
Comments in Baby Llama 2 start with the "#" symbol and are ignored by the interpreter.
The next two lines define two variables, x and y, and assign them the values 10 and 5, respectively.
The following three lines perform arithmetic operations on these variables and store the results in result1, result2, and result3.
Finally, there are three print statements that output the values of the results.
Now, you can run your main implementation file (baby_llama_2.py) with the "baby_llama_demo.bl2" file as input. 
The interpreter will read the code from the file, tokenize it, parse it, and execute it. The output will be displayed on the console:

Baby Llama 2 Code Output:
15
50
2.5
This output demonstrates the successful execution of the Baby Llama 2 code, 
showing the results of the arithmetic operations and the output generated by the print statements.    
